...
Первое, что приходит на ум - это купить акции когда цена наименьшая, а продать когда наибольшая, но как раз в приведенном примере минимальное `arr[4]`  и после покупки продать акции уже не выйдет, а оптимальное решение - купить в день `1` а продать в день `2`.
